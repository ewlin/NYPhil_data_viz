...
(function e(t, n, r) {
	function s(o, u) {
		...
		d3.json('../../data/composers.json', function (err, d) {
			...
			//.attr('stroke', '#AB7286')
			.attr('stroke-dasharray', '7, 2').attr('d', function (d) {
				return line([{ percentageOfTotalRepeatsLiving: 0 }]);
			}).style('stroke-width', function () {
				return isMobile().any() ? '2px' : '3px';
			});
	...
	}, { "../../temp_utils/generate_seasons.js": 4, "../../temp_utils/is-mobile.js": 5, "../../temp_utils/moving_averages.js": 6, "just-debounce-it": 2, "scrollmagic": 3 }], 2: [function (require, module, exports) {
